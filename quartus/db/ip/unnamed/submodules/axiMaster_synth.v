...
//
// On Mon Apr 25 19:22:01 CEST 2022
//
//
// Ports:
// Name                         I/O  size props
...
module axiMaster_synth(CLK,
  ...
  wire axi_sig_arSig_src_dropWire$whas,
       ...
       master_shim_shim_awff_rv$EN_port0__write,
  ...
  wire WILL_FIRE_RL_master_putAXI4_WFlit;
  ...
  wire [127 : 0] f_wdata__h1725;
  wire [43 : 0] master_shim_shim_arff_rv_BITS_43_TO_0__q1,
		master_shim_shim_awff_rvport1__read_BITS_43_TO_0__q2;
  wire [31 : 0] master_cnt_2_PLUS_1000___d23, x__h1874;
  wire [27 : 0] master_nextWriteAddr_MUL_10___d9;
  ...
  // rule RL_master_putAXI4_WFlit
  assign WILL_FIRE_RL_master_putAXI4_WFlit =
	     !master_shim_shim_wff_rv[145] && !master_reqSent ;
  ...
  assign master_shim_shim_awff_rv$EN_port0__write =
	     !master_shim_shim_awff_rv[44] && !master_awSent ;
  assign master_shim_shim_awff_rv$port0__write_1 =
	     { 2'd2, master_nextWriteAddr_MUL_10___d9[13:0], 29'd2730666 } ;
  ...
  assign master_shim_shim_wff_rv$port0__write_1 =
	     { 1'd1, f_wdata__h1725, 17'h15555 } ;
  assign master_shim_shim_wff_rv$port1__read =
	     WILL_FIRE_RL_master_putAXI4_WFlit ?
  ...
  // register master_awSent
  assign master_awSent$D_IN = master_nextWriteAddr == 14'd2 || master_awSent ;
  assign master_awSent$EN = !master_shim_shim_awff_rv[44] && !master_awSent ;

  // register master_cnt
  assign master_cnt$D_IN = (master_cnt == 32'd1) ? 32'd0 : x__h1874 ;
  assign master_cnt$EN = WILL_FIRE_RL_master_putAXI4_WFlit ;

  // register master_nextWriteAddr
  assign master_nextWriteAddr$D_IN = master_nextWriteAddr + 14'd1 ;
  assign master_nextWriteAddr$EN =
	     !master_shim_shim_awff_rv[44] && !master_awSent ;

  // register master_reqSent
  assign master_reqSent$D_IN = 1'd1 ;
  assign master_reqSent$EN =
	     WILL_FIRE_RL_master_putAXI4_WFlit && master_cnt == 32'd1 ;

  // register master_rspCnt
  assign master_rspCnt$D_IN = 32'h0 ;
  assign master_rspCnt$EN = 1'b0 ;
  ...
  // register master_shim_shim_bff_rv
  assign master_shim_shim_bff_rv$D_IN = master_shim_shim_bff_rv$port1__read ;
  ...
  // remaining internal signals
  assign f_wdata__h1725 = { 96'd0, master_cnt_2_PLUS_1000___d23 } ;
  assign master_cnt_2_PLUS_1000___d23 = master_cnt + 32'd1000 ;
  assign master_nextWriteAddr_MUL_10___d9 = master_nextWriteAddr * 14'd10 ;
  ...
  assign x__h1874 = master_cnt + 32'd1 ;
  ...
  begin
    #0;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_master_putAXI4_WFlit)
	begin
	  v__h1925 = $time;
	  #0;
	end
