...
module mkP2_Core(CLK,
  ...
  wire [5 : 0] core$core_mem_master_arid,
  ...
  assign core$dma_server_arburst = 2'bxx /* unspecified value */  ;
  assign core$dma_server_arcache = 4'bxxxx /* unspecified value */  ;
  assign core$dma_server_arid = 6'bxxxxxx /* unspecified value */  ;
  assign core$dma_server_arlen = 8'bxxxxxxxx /* unspecified value */  ;
  assign core$dma_server_arlock = 1'bx /* unspecified value */  ;
  assign core$dma_server_arprot = 3'bxxx /* unspecified value */  ;
  assign core$dma_server_arqos = 4'bxxxx /* unspecified value */  ;
  assign core$dma_server_arregion = 4'bxxxx /* unspecified value */  ;
  assign core$dma_server_arsize = 3'bxxx /* unspecified value */  ;
  assign core$dma_server_arvalid = 1'd0 ;
  assign core$dma_server_awaddr =
	     64'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  ;
  assign core$dma_server_awburst = 2'bxx /* unspecified value */  ;
  assign core$dma_server_awcache = 4'bxxxx /* unspecified value */  ;
  assign core$dma_server_awid = 6'bxxxxxx /* unspecified value */  ;
  assign core$dma_server_awlen = 8'bxxxxxxxx /* unspecified value */  ;
  assign core$dma_server_awlock = 1'bx /* unspecified value */  ;
  assign core$dma_server_awprot = 3'bxxx /* unspecified value */  ;
  assign core$dma_server_awqos = 4'bxxxx /* unspecified value */  ;
  assign core$dma_server_awregion = 4'bxxxx /* unspecified value */  ;
  assign core$dma_server_awsize = 3'bxxx /* unspecified value */  ;
  ...
  assign core$dma_server_wlast = 1'bx /* unspecified value */  ;
