...
TOP_LEVEL_NAME="Example3"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="D:/programs/quartus/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Example3.vhd"
fi
