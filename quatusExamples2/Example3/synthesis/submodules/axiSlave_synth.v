...
module axiSlave_synth(CLK,
  ...
  wire [4 : 0] slave_shim_shim_bff_rv$port2__read;
  ...
  wire [255 : 0] slave_shim_shim_wff_rv_port1__read_BITS_144_TO_ETC___d10,
		 slave_shim_shim_wff_rv_port1__read_BITS_144_TO_ETC___d12;
  wire [132 : 0] slave_shim_shim_rff_rv_BITS_132_TO_0__q2;
  wire [3 : 0] slave_shim_shim_bff_rv_BITS_3_TO_0__q1;
  ...
  // value method b_bid
  assign bid = slave_shim_shim_bff_rv_BITS_3_TO_0__q1[3:2] ;

  // value method b_bresp
  assign bresp = slave_shim_shim_bff_rv_BITS_3_TO_0__q1[1:0] ;

  // value method b_bvalid
  assign bvalid = slave_shim_shim_bff_rv[4] ;

  // value method ar_arready
  assign arready = !slave_shim_shim_arff_rv[45] ;

  // value method r_rid
  assign rid = slave_shim_shim_rff_rv_BITS_132_TO_0__q2[132:131] ;

  // value method r_rdata
  assign rdata = slave_shim_shim_rff_rv_BITS_132_TO_0__q2[130:3] ;

  // value method r_rresp
  assign rresp = slave_shim_shim_rff_rv_BITS_132_TO_0__q2[2:1] ;

  // value method r_rlast
  assign rlast = slave_shim_shim_rff_rv_BITS_132_TO_0__q2[0] ;
  ...
  assign axi_sig_bSig_src_dropWire$whas =
	     slave_shim_shim_bff_rv[4] && bready ;
  ...
  assign slave_shim_shim_awff_rv$port2__read =
	     slave_shim_shim_awff_rv$port1__read[45] ?
	       46'h0AAAAAAAAAAA :
	       slave_shim_shim_awff_rv$port1__read ;
  ...
  assign slave_shim_shim_wff_rv$port2__read =
	     slave_shim_shim_wff_rv$port1__read[145] ?
	       146'h0AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA :
	       slave_shim_shim_wff_rv$port1__read ;
  assign slave_shim_shim_bff_rv$EN_port1__write =
	     slave_shim_shim_bff_rv[4] && axi_sig_bSig_src_dropWire$whas ;
  ...
  // remaining internal signals
  assign slave_shim_shim_bff_rv_BITS_3_TO_0__q1 =
	     slave_shim_shim_bff_rv[3:0] ;
  assign slave_shim_shim_rff_rv_BITS_132_TO_0__q2 =
	     slave_shim_shim_rff_rv[132:0] ;
  assign slave_shim_shim_wff_rv_port1__read_BITS_144_TO_ETC___d10 =
	     slave_shim_shim_wff_rv$port1__read[144:17] *
	     slave_shim_shim_wff_rv$port1__read[144:17] ;
  assign slave_shim_shim_wff_rv_port1__read_BITS_144_TO_ETC___d12 =
	     slave_shim_shim_wff_rv_port1__read_BITS_144_TO_ETC___d10[127:0] *
	     128'd1000 ;
  ...
  begin
	...
	$display("WARNING: %m - putting into a Sink that can't be put into");
    if (RST_N != `BSV_RESET_VALUE)
      if (slave_shim_shim_wff_rv$port1__read[145])
	begin
	  v__h1382 = $time;
	  #0;
	end
	...
	$display("%0t - SLAVE %d - computed %d",
		 v__h1382,
		 $signed(32'd1),
		 slave_shim_shim_wff_rv_port1__read_BITS_144_TO_ETC___d12[127:0]);
    if (RST_N != `BSV_RESET_VALUE)
      if (axi_sig_bSig_src_dropWire$whas && !slave_shim_shim_bff_rv[4])
